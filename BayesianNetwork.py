...
def main(structurefile, valuesfile, queriesfile):
    # STRICTLY do NOT modify the code in the main function here
    # if len(sys.argv) != 4:
    #     print("\nUsage: python BayesianNetwork.py structure.json values.json queries.json \n")
    #     raise ValueError("Wrong number of arguments!")

    structure_filename = structurefile
    values_filename = valuesfile
    queries_filename = queriesfile
...
if __name__ == "__main__":
    main('data/structure.json', 'data/values.json', 'data/queries.json')
